...
internal struct bvec8 {
    ...
    //##########################################################################################################################################################
    public bvec8() {}
    public bvec8(u64 V)                                          {L=V;}
    public bvec8(u32 A, u32 B)                                   {i0=A; i1=B;}
    public bvec8(u16 A, u16 B, u16 C, u16 D)                     {s0=A; s1=B; s2=C; s3=D;}
    public bvec8(u8 A, u8 B, u8 C, u8 D, u8 E, u8 F, u8 G, u8 H) {b0=A; b1=B; b2=C; b3=D; b4=E; b5=F; b6=G; b7=H;}

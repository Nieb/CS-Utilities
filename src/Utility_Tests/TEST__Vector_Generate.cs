...
internal static partial class Program {
    static void Test__Vector_Generate() {
        ...
        #if false
            CONOUT($"""
                FromPchYaw(-360,   0) == {FromPchYaw(ToRad(-360), 0):0}    {FromPchYaw(ToRad(-360), 0).IsApproximately(( 0, 0, 1))}
                FromPchYaw(-270,   0) == {FromPchYaw(ToRad(-270), 0):0}    {FromPchYaw(ToRad(-270), 0).IsApproximately(( 0,-1, 0))}
                FromPchYaw(-180,   0) == {FromPchYaw(ToRad(-180), 0):0}    {FromPchYaw(ToRad(-180), 0).IsApproximately(( 0, 0,-1))}
                FromPchYaw( -90,   0) == {FromPchYaw(ToRad( -90), 0):0}    {FromPchYaw(ToRad( -90), 0).IsApproximately(( 0, 1, 0))}
                FromPchYaw(   0,   0) == {FromPchYaw(         0 , 0):0}    {FromPchYaw(         0 , 0).IsApproximately(( 0, 0, 1))}
                FromPchYaw(  90,   0) == {FromPchYaw(ToRad(  90), 0):0}    {FromPchYaw(ToRad(  90), 0).IsApproximately(( 0,-1, 0))}
                FromPchYaw( 180,   0) == {FromPchYaw(ToRad( 180), 0):0}    {FromPchYaw(ToRad( 180), 0).IsApproximately(( 0, 0,-1))}
                FromPchYaw( 270,   0) == {FromPchYaw(ToRad( 270), 0):0}    {FromPchYaw(ToRad( 270), 0).IsApproximately(( 0, 1, 0))}
                FromPchYaw( 360,   0) == {FromPchYaw(ToRad( 360), 0):0}    {FromPchYaw(ToRad( 360), 0).IsApproximately(( 0, 0, 1))}

                FromPchYaw(   0,-360) == {FromPchYaw( 0,ToRad(-360)):0}    {FromPchYaw( 0,ToRad(-360)).IsApproximately(( 0, 0, 1))}
                FromPchYaw(   0,-270) == {FromPchYaw( 0,ToRad(-270)):0}    {FromPchYaw( 0,ToRad(-270)).IsApproximately(( 1, 0, 0))}
                FromPchYaw(   0,-180) == {FromPchYaw( 0,ToRad(-180)):0}    {FromPchYaw( 0,ToRad(-180)).IsApproximately(( 0, 0,-1))}
                FromPchYaw(   0, -90) == {FromPchYaw( 0,ToRad( -90)):0}    {FromPchYaw( 0,ToRad( -90)).IsApproximately((-1, 0, 0))}
                FromPchYaw(   0,   0) == {FromPchYaw( 0,         0 ):0}    {FromPchYaw( 0,         0 ).IsApproximately(( 0, 0, 1))}
                FromPchYaw(   0,  90) == {FromPchYaw( 0,ToRad(  90)):0}    {FromPchYaw( 0,ToRad(  90)).IsApproximately(( 1, 0, 0))}
                FromPchYaw(   0, 180) == {FromPchYaw( 0,ToRad( 180)):0}    {FromPchYaw( 0,ToRad( 180)).IsApproximately(( 0, 0,-1))}
                FromPchYaw(   0, 270) == {FromPchYaw( 0,ToRad( 270)):0}    {FromPchYaw( 0,ToRad( 270)).IsApproximately((-1, 0, 0))}
        ...
        TEST("RotFromVec()", true
            ...
            CONOUT($"""
                ...
                {FromPchYaw(ToRad(-45f), ToRad( 45f))}    {ToDeg(RotFromVec(FromPchYaw(ToRad(-45f), ToRad( 45f))))}

                {normalize(1f,1f,1f)}    {ToDeg(RotFromVec((1f,1f,1f)))}
            """);
        #endif
